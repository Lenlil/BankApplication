...
{
    public class TransferThisBankTransactionViewModel
    {
        ...
        [Required(ErrorMessage = "Target bank must be specified")]
        [MaxLength(50)]
        public string Bank { get; set; }
        [Required(ErrorMessage = "Target account must be specified")]
        [Range(0, int.MaxValue)]
